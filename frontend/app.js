  ...
  <div class="card" style="padding: 2rem;">
    ...
    <div style="margin-top: 2rem;">
      ...
      <pre style="background: #f4f4f4; padding: 1rem; border-radius: 4px; display: flex; justify-content: space-between; align-items: center; overflow-x: auto;"><code>pip install gh-download-cli</code>
        <button aria-label="Copy to clipboard" onclick=${(e) => { e.preventDefault(); navigator.clipboard.writeText('pip install gh-download-cli'); }} style="background: transparent; border: none; outline: none; cursor: pointer; padding: 0.4rem; display: flex; align-items: center; color: inherit;">
